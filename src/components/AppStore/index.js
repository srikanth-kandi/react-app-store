...
class AppStore extends Component {
  ...
  getFilteredSearchApps = (userInput, filteredApps) => {
    const filteredSearchApps = filteredApps.filter(eachApp =>
      eachApp.appName.toLowerCase().includes(userInput.toLowerCase()),
    )
    return filteredSearchApps
  }
  ...
  render() {
    ...
    const filteredSearchApps = this.getFilteredSearchApps(
      userInput,
      filteredApps,
    )
    return (
      <div className="bg-container">
        ...
        <ul className="app-items-container">
          {filteredSearchApps.map(appDetails => (
